...
public enum SMaterial {
    ...
    private static final Map<String, SMaterial> NAME_CACHE = new HashMap<>();
    ...
    SMaterial(int data, String... legacy) {
        this.data = (byte) data;
        this.legacy = legacy;
    ...
    SMaterial(String... legacy) {
        this(0, legacy);
    }
    
    private static Optional<SMaterial> getIfPresent(String name) {
    ...
    private static SMaterial requestOldXMaterial(String name, byte data) {
    ...
    private static Optional<SMaterial> matchXMaterialWithData(String name) {
    ...
    public static SMaterial matchXMaterial(ItemStack item) {
        ...
        Optional<SMaterial> result = matchDefinedXMaterial(material, data);
        if (result.isPresent()) {
            return result.get();
        }
    ...
    private static Optional<SMaterial> matchDefinedXMaterial(String name, byte data) {
        ...
        if (Data.ISFLAT || !isAMap && data <= 0 && !(duplicated = isDuplicated(name))) {
            Optional<SMaterial> xMaterial = getIfPresent(name);
        ...
        SMaterial oldXMaterial = requestOldXMaterial(name, data);
    ...
    public SMaterial or(SMaterial alternateMaterial) {
